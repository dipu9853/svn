...
<head>
	...
	<body>
	<iframe frameborder="0" scrolling="no" src="../../user/MasterHeader.jsp" style="min-width:100%;height:150px;"></iframe>
					...
					<ul class="nav" id="side-menu">
						...
						<li>
                          ...
                          <li>
					       ...
					       <li>
                             <a href="ExamResult.jsp"><i class="glyphicon glyphicon-search"style="font-size:12px;color:rgb(234,67,53)"></i> Exam Results</a>
						  </li>
                            <li>
